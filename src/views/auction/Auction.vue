      ...
      if (newBid !== oldBid) {
        ...
        setTimeout(() => {
          this.bids = this.bids.map((bid, index) => ({
            ...bid,
            time: index === 0 ? "Just now" : index === 1 ? "2 minutes ago" : index === 2 ? "5 minutes ago" : "10 minutes ago",
          }));
        }, 1000);
      }
    }
      ...
      <BRow class="g-4">
        ...
        <BCol lg="7">
          <div>
            ...
            ><i class="ri-eye-line me-1 align-bottom"></i> 8,634 watching this</BBadge
            >
