          ...
          <BCol lg="7">
            <div>
              ...
              <div class="hstack gap-3 flex-wrap text-base">
                ...
                <div class="text-muted">
                  Owner :
                  <span class="text-body fw-mediu">Rickey Teran</span>
                </div>
                <div class="vr"></div>
                <div class="text-muted">
                  Created On :
              ...
              <div class="mt-4 text-muted">
                ...
                <p>
                  ...
                  social practices that are steady over time. In art, a pattern
                  is a repetition of specific visual elements. The
              ...
              <div class="product-content mt-5">
                ...
                <BTabs nav-class="nav-tabs nav-tabs-custom nav-success text-lg">
                  <BTab
                    title="Activity"
