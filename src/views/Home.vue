      ...
      <BRow class="g-4">
        ...
        <BCol lg="8">
          <div>
            ...
            <BBadge
              variant="info-subtle"
              class="bg-info-subtle text-info mb-3 fs-12"
              ><i class="ri-eye-line me-1 align-bottom"></i> 8,634 people views
              this</BBadge
            >
                          ...
                          <th scope="row">
                            <div class="d-flex align-items-center">
                              ...
                              <router-link
                                ...
                                class="text-body"
                              >
                                <span class="mb-0 ms-2">Brave Tigers NFT</span>
                              </router-link>
                            </div>
                          </th>
                          <td>0.235 ETH</td>
                          ...
                          <th scope="row">
                            <div class="d-flex align-items-center">
                              ...
                              <router-link
                                ...
                                class="text-body"
                              >
                                <span class="mb-0 ms-2">Evolved Reality</span>
                              </router-link>
                            </div>
                          </th>
                          <td>130.39 ETH</td>
                          ...
                          <th scope="row">
                            <div class="d-flex align-items-center">
                              ...
                              <router-link
                                ...
                                class="text-body"
                              >
                                <span class="mb-0 ms-2">Robotic Body Art</span>
                              </router-link>
                            </div>
                          </th>
                          <td>81.72 ETH</td>
